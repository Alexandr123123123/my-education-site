...
import './CareerNewsCards.css'

const CareerNewsCards = () => {
  ...
  return (
    <div className="career-news-cards">
      <div className="career-news-cards-cards-body">
        <div className="career-news-cards-cards-body-container">
          {items.map((item) => (
            <div className="career-news-cards-cards-body-item">
              <div className="career-news-cards-cards-body-item-content">
                <div className="career-news-cards-cards-body-item-title">
                  7 maart 2025 | Carrière
                </div>
                <div className="career-news-cards-cards-body-item-image">
                  <img src={item.filename} alt="abc"></img>
                </div>
                <div className="career-news-cards-cards-body-item-nomination">{item.title}</div>
              </div>
            </div>
          ))}
        </div>
...
export default CareerNewsCards
