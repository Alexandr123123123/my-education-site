...
const CareerPathsBody_2 = () => {
  ...
  return (
    <div className="careers-career-paths-body_2">
      {/* left */}
      <div className="careers-career-paths-body_2-item">
        <CareerPathsBodyCard
          workers={workers[0]}
...
export default CareerPathsBody_2
